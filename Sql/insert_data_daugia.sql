...
('29', '4950000', '08:23:00', '14:29:00', '29.jpg',' Cảm ơn các bạn đã đến với chúng tôi. Sau khi nhận giày xong nếu có vấn đề nào bạn chưa vừa lòng làm ơn hãy liên hệ ngay với chúng tôi để được hỗ trợ và giải quyết .các bạn hãy vui lòng dành chút thời gian đánh giá sản phẩm để shop lấy động lực phục vụ các bạn tốt hơn nhé !!/CAM KẾT CỦA SHOP :/Bán đúng chất lượng về sản  phẩm như mô tả /Chuyển đúng hàng , đúng mẫu mã và size giày /Màu sắc đúng với đơn đặt hàng /Trả hàng hoàn tiền 100% nếu giày không đúng với mô tả/size: 41', '13000', '2021-12-15', '2021-12-14', '2022-01-30', '100', 'Giày Alexander McQueen trắng gót đen Rep 1:1', 'Đã duyệt', '3', 'khoatran'),
